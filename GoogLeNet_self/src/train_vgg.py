...
from GoogLeNet_self.tools.my_dataset import CatDogDataset
from GoogLeNet_self.tools.common_tools import get_vgg16
...
if __name__ == "__main__":
    ...
    data_dir = os.path.join(r'C:\Users\hanch\PycharmProjects\cv_paper\data\dogs-vs-cats-redux-kernels-edition\train')
    ...
    # ============================ step 2/5 模型 ============================
    googlenet_model = get_vgg16(device, True)
    ...
    # change the all three ftrs as output num_classes to desire number of classes
    print(googlenet_model)
